...
from app.mod_api.resources.table import Table, Tables
from app.mod_api.resources.field import Field, Fields
...
api.add_resource(Field, "/api/field",
                        "/api/field/<int:id>")
api.add_resource(Fields, "/api/fields",
                         "/api/field/<int:id>")
